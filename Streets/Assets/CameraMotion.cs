...
public class CameraMotion : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (Camera.main != null)
		{
			...
			Camera.main.transform.Translate(dx * translate_factor, dz * translate_factor, dy * zoom_factor);
	...
	void create_new_plane()
	{
		...
		s.transform.position = new Vector3(0.0f, -0.02f, 2 * plane_size * (index + 0.0f));
